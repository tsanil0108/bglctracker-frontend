      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="font-display text-lg font-semibold leading-none tracking-tight text-ink-900">
                Ledger
              </p>
          ...
          <button
            type="button"
            className="rounded-lg p-1 text-muted hover:bg-ink-50 lg:hidden"
            onClick={
              onClose
            }
        ...
        <div className="border-t border-border px-5 py-4">
          ...
          <p className="text-[11px] leading-relaxed text-muted">
            Connected trade finance workspace for Group Companies, Bank Guarantees, Letters of Credit, Fixed Deposits and Bank Limits.
          </p>
