    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-900 px-4 py-10">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="rounded-xl2 bg-white p-6 shadow-xl sm:p-8">
          <h2 className="mb-1 font-display text-lg font-semibold text-ink-900">Sign in</h2>
          <p className="mb-6 text-sm text-muted">Track guarantees, credits and deposits in one place.</p>
